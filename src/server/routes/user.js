...
router.put("/update-member/:id", [authorization(), isuser()], user.update_member());
router.delete("/delete-member/:id", [authorization(), isuser()], user.delete_member());
router.get("/pro-details/:id", [authorization(), isuser()], user.get_pro_details());
router.put("/pro-details/:id", [authorization(), isuser()], user.update_pro_details());
